...
const COMPONENT_PROPS = {
  ...
  hingeType: { enum: ["cup", "pianoFront", "straightBack", "custom"], description: "herraje del frente: define la luz calculada de la abertura" },
  hingeA: { ...num, description: "herraje custom: eje → cara exterior (m)" },
  hingeC: { ...num, description: "herraje custom: eje → canto (m)" },
  gap: { ...num, description: "luz propia de esta abertura (m); pisa la calculada" },
